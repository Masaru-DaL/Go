- [1. REST API only golang](#1-rest-api-only-golang)
...
# 1. REST API only golang

REST APIのサーバをFWを使わずに立てます。
参考: [Go Web Examples - Learn Web Programming in Go by Examples](https://gowebexamples.com/)
